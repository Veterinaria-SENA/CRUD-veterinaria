...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VETERINARIA  HUELLITAS");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/imgprinc.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         jLerror.setText("");
        if (validar.usuario(txtUsuario.getText(),String.valueOf(txtPassword.getPassword()))==true)
        {
        ...
        {
            jLerror.setText("El usuario o la contraseña son erroneos");
        }
